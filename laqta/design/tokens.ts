...
export const gradients = {
  ...
  // Contact gradients
  contactOuter: 'linear-gradient(358deg, rgba(0,0,0,0.8) 0%, rgba(255,255,255,0.2) 100%)',
  contactInner: 'linear-gradient(180deg, rgba(29,34,53,1) 0%, rgba(18,19,24,1) 100%)',

  // Service overlay
  serviceOverlay: 'linear-gradient(to top, rgba(0,0,0,0.95) 0%, rgba(0,0,0,0.7) 40%, transparent 100%)',
...
export const typography = {
  ...
  display: {
    '2xl': { fontSize: '72px', lineHeight: '80px', letterSpacing: '-0.02em' },
  ...
  // Body sizes (content)
  body: {
    '2xl': { fontSize: '22px', lineHeight: '34px', letterSpacing: '-0.02em' },
