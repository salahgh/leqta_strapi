        ...
        <section className="py-12 md:py-16 px-2 md:px-12">
            ...
            >
                <div
                    ...
                    style={{ opacity: 0 }}
                >
                    <Badge variant="accent">Our Foundation</Badge>
                </div>
                <h2
                ...
                >
                    Discover what drives us to create exceptional content and
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-2">
                ...
                <Image
                    ...
                    width={1000}
                    height={1000}
                    className="z-0 group-hover:opacity-20 transition-opacity duration-500"
                />
                <Image
                    src="/images/laqta_01.svg"
                    alt="LAQTA Logo Curve"
