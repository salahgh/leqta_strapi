...
export const CompetitiveEdge = async () => {
    ...
    return (
        ...
        >
            <div className="text-center space-y-4 md:space-y-6 py-6 md:py-8 flex flex-col items-center animate-fade-in">
                <div className="animate-slide-down">
                    <Badge>{t('badge')}</Badge>
                </div>

                <h2 className="text-white max-w-2xl leading-tight animate-slide-up" style={{ animationDelay: "150ms" }}>
                    {t('title')}
                </h2>
                <p className="text-responsive-lg text-gray-300 max-w-2xl leading-relaxed animate-fade-in" style={{ animationDelay: "300ms" }}>
                    {t('description')}
                </p>
            </div>
