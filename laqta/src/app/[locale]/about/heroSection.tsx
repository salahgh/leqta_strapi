    ...
    return (
        <section className="flex lg:flex-row flex-col items-center px-4 md:px-8 lg:px-12 py-12 md:py-16 lg:py-20 gap-8 md:gap-12 lg:gap-16 max-w-7xl mx-auto">
            <div className="flex-1 space-y-4 md:space-y-6 lg:space-y-8">
                ...
                <h2 className="text-gray-200 leading-tight py-2 animate-slide-up">
                ...
                <p className="leading-relaxed text-gray-300 text-responsive-lg max-w-xl animate-fade-in" style={{ animationDelay: "300ms" }}>
                    {t('description')}
                </p>

                <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-4 animate-fade-in" style={{ animationDelay: "500ms" }}>
            ...
            <div className="flex-1 w-full lg:w-auto animate-fade-in" style={{ animationDelay: "700ms" }}>
