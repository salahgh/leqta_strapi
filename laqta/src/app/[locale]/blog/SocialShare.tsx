...
export const SocialShare: React.FC<SocialShareProps> = ({
    ...
    // Don't render share links until we have the full URL
    if (!fullUrl) {
        return (
            <div className="relative">
                <button
                    disabled
                    className={`${buttonSize} text-gray-400 transition-colors`}
                    title="Share"
                >
                    <svg
                        className={iconSize}
    ...
    return (
        <div className="relative">
            <button
                ...
                className={`${buttonSize} text-gray-500 hover:text-blue-500 transition-colors`}
                title="Share"
            >
                <svg
                    className={iconSize}
