...
const seedBlogs = async (strapi, blogsData) => {
    var _a, _b;
    try {
        ...
        for (const blogData of blogsData) {
            ...
            const blogWithRelations = {
                ...blogData.base,
                author: (_a = authors[Math.floor(Math.random() * authors.length)]) === null || _a === void 0 ? void 0 : _a.id,
                category: (_b = categories[Math.floor(Math.random() * categories.length)]) === null || _b === void 0 ? void 0 : _b.id,
