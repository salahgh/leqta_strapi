...
export interface ApiCookieConsentCookieConsent extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Cookie consent banner content for Law 18-07 compliance';
  ...
  attributes: {
    acceptAllButtonText: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    alwaysActiveText: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      ...
      Schema.Attribute.DefaultTo<'Always Active'>;
    analyticsCookiesDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    analyticsCookiesTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      ...
      Schema.Attribute.DefaultTo<'Analytics Cookies'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text &
    ...
    lawReferenceDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    lawReferenceTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      ...
      Schema.Attribute.DefaultTo<'Law 18-07 Compliance:'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cookie-consent.cookie-consent'
    >;
    managePreferencesText: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      ...
      Schema.Attribute.DefaultTo<'Manage cookie preferences'>;
    marketingCookiesDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    marketingCookiesTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      ...
      Schema.Attribute.DefaultTo<'Marketing Cookies'>;
    necessaryCookiesDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    necessaryCookiesTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      ...
      Schema.Attribute.DefaultTo<'Necessary Cookies'>;
    privacyPolicyLinkText: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Read our Privacy Policy'>;
    publishedAt: Schema.Attribute.DateTime;
    rejectAllButtonText: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    rightsNotice: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    savePreferencesButtonText: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    title: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'We Value Your Privacy'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMissionMission extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Company missions, vision, and values';
    displayName: 'Mission';
    pluralName: 'missions';
...
export interface ApiPartnerRequestPartnerRequest
  ...
  info: {
    description: 'Partnership application submissions';
  ...
  attributes: {
    ...
    partnershipType: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiPartnershipTypePartnershipType
  extends Struct.CollectionTypeSchema {
  collectionName: 'partnership_types';
  info: {
    description: 'Types of partnership available';
    displayName: 'Partnership Type';
    pluralName: 'partnership-types';
    singularName: 'partnership-type';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::partnership-type.partnership-type'
    >;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPlanPlan extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Pricing plans with sections and feature points';
    displayName: 'Plan';
    pluralName: 'plans';
    singularName: 'plan';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customPricingText: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    featured: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    isCustomPricing: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<'plan.plan-section', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Project showcase content type';
    displayName: 'Project';
    pluralName: 'projects';
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global website settings including social links and contact information';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::partnership-type.partnership-type': ApiPartnershipTypePartnershipType;
